...
Статус: версия 0.1 — исследовательский прототип. Методика, тесты и парный eval harness реализованы. Прогон текущих 18 кейсов на Codex gpt-5.6-sol не показал общего прироста: средняя парная дельта составила +0,04, arch выиграл 12 сравнений, baseline — 14, ещё 28 завершились ничьей. Четыре architecture-view кейса дали +0,67, а прежние 14 кейсов — −0,14; весь набор использовался для настройки, поэтому прогон не даёт независимой проверки. Результат и ограничения описаны в [отчёте от 19 августа 2026 года](docs/benchmark-2026-08-19.md).
...
- [Benchmark архитектурных представлений](docs/benchmark-2026-08-19.md)
