...
Реализация runner, blind-pair builder, automated judge runner, scorer, восьмимерной rubric и 18 кейсов завершена. Зафиксированы два многократных прогона Codex gpt-5.6-sol с reasoning effort max и автоматическим judge claude-opus-5.
...
Второй прогон использовал текущие 18 кейсов, три повтора и восьмимерную rubric с максимумом 16:
